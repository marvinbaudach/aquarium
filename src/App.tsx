...
type SphereData = [scale: number, color: string, speed: number, position: [number, number, number]]

type AquariumProps = ThreeElements['group']
...
export default function App({ spheres }: { spheres: SphereData[] }) {
  return (
...
function Sphere({ position, scale = 1, speed = 0.1, color = 'white' }: SphereProps) {
  return (
